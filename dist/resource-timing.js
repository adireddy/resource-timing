...
ResourceTiming.prototype = {
	...
	,setResourceTimingBufferSize: function(val) {
		if(this._perfObj == null || ($_=this._perfObj,$bind($_,$_.setResourceTimingBufferSize)) != null) return;
		this._perfObj.setResourceTimingBufferSize(val);
	}
};
var $_, $fid = 0;
